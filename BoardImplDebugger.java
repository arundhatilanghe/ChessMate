...
public class BoardImplDebugger extends AbstractBoard implements Board {
	...
	public BoardImplDebugger() {
		...
		board[1][6] = null;
		board[1][7] = null;
		board[1][0].setLocation(new LocationImpl(4, 0));
		board[4][0] = board[1][0];
		board[1][0] = null;
		board[1][1].setLocation(new LocationImpl(2, 1));
		board[2][1] = board[1][1];
		board[1][1] = null;
		board[1][2].setLocation(new LocationImpl(3, 2));
		board[3][2] = board[1][2];
		board[1][2] = null;
		...
		board[6][1] = null;
		board[6][3] = null;
		board[7][3].setLocation(new LocationImpl(7, 5));
		board[7][5] = board[7][3];
		board[7][3] = null;
		board[7][0].setLocation(new LocationImpl(7, 3));
		board[7][3] = board[7][0];
		board[7][0] = null;
		board[6][2].setLocation(new LocationImpl(5, 2));
		board[5][2] = board[6][2];
		board[6][2] = null;
		board[6][4].setLocation(new LocationImpl(2, 4));
		board[2][4] = board[6][4];
		board[6][4] = null;
		board[6][5].setLocation(new LocationImpl(5, 5));
		board[5][5] = board[6][5];
		board[6][5] = null;
		board[6][6].setLocation(new LocationImpl(3, 7));
		board[3][7] = board[6][6];
		board[6][6] = null;
		board[7][2].setLocation(new LocationImpl(4, 5));
		board[4][5] = board[7][2];
		board[7][2] = null;
	}
