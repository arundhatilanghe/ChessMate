...
public interface Board {
	 ...
	 */
	location.LocationImpl[] aiMove(Piece.Color color);
	...
	/**
	 * Moves the piece from one spot to another even if not valid. Only used for
	 * testing.
	 *
	 * @param x the x coordinate of the piece
	 * @param y the y coordinate of the piece
	...
	/**
	 * Moves the piece from one spot to another even if not valid and doesnt change
	 * score. Only used for testing.
	 *
	 * @param x the x coordinate of the piece
	 * @param y the y coordinate of the piece
	 * @param r The x coordinate to move to
	 ...
	 */
	location.LocationImpl isValidMove(int x, int y, int r, int c);
	 ...
	 * @param c The proposed y coordinate of the move
	 * @return a locationImpl. The output can be converted to boolean with
	 *         locationToBoolean(). 100,100 means true; -100,-100 means false;
	 */
	location.LocationImpl isValidProtect(int x, int y, int r, int c);
	...
	/**
	 * Checks to see if the location is not -100,-100. If it is -100 -100 then
	 * false, otherwise true;
	 *
	 * @param input Location to be converted to boolean
	 * @return whether or not the location is valid or not.
	 */
	boolean locationToBoolean(location.LocationImpl input);
	 ...
	 */
	location.LocationImpl isCheck(int x, int y);
	 ...
	 * @return the location of the piece checking the (x,y) piece.
	 */
	location.LocationImpl isProtect(int x, int y);
	 ...
	 * @return Whether or not the player's king would be checked from their own
	 *         move.
	 */
